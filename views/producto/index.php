  ...
  <main>
    <div class="row g-5">
      <div class="col-md-7 col-lg-8" id="contenedor_producto">
        <div class="col-sm-4">
          <button id="button_accion" data-opcion="crear" type="button" class="w-100 btn btn-outline-primary btn-lg mb-3">Agregar producto</button>
        </div>
      </div>
    </div>
  </main>
    ...
    <div class="modal-content rounded-4 shadow">
      ...
      <div class="modal-body p-5 pt-0">
        <form class="needs-validation" id="form_producto" novalidate>
          ...
          <div class="form-floating mb-3">
            <select class="form-select" id="tipo_medida" required>
              <option value="">-- Selecciona --</option>
            </select>
            <label for="floatingInput">Tipo de medida</label>
            <div class="invalid-feedback">
              El campo es obligatorio
            </div>
          </div>
          <div class="form-floating mb-3">
            <input type="text" class="form-control rounded-3" id="codigo" placeholder="Codigo" required>
          ...
          <div class="form-floating mb-3">
            <input type="text" class="form-control rounded-3" id="presentacion" placeholder="Presentacion" required>
...
<?php
  $script = "<script src='build/js/producto.js'></script>";
?>