  ...
  <main>
    <div class="row g-5">
      <div class="col-md-7 col-lg-8">
        <div class="col-sm-4">
          <button id="button_accion" data-opcion="crear" type="button" class="w-100 btn btn-outline-primary btn-lg mb-3">Agregar marca</button>
        </div>
      </div>
    </div>
  </main>
...
<div class="modal modal-sheet py-5" tabindex="-1" role="dialog" id="modalMarca">
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      ...
      <div class="modal-body py-0">
        <form class="needs-validation" id="form_marca" novalidate>
          <div class="form-floating mb-3">
            <input type="text" class="form-control rounded-3" id="descripcion" placeholder="Nombre marca" required>
            <label for="floatingInput">Nombre marca</label>
...
<div class="modal modal-sheet py-5" tabindex="-1" role="dialog" id="modalSheet">
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow">
      <div class="modal-header border-bottom-0">
        <h1 class="modal-title fs-5">Eliminar marca</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body py-0">
...
<?php
    $script = "<script src='build/js/marca.js'></script>";
?>